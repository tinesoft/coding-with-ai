...
function schoolSlides() {
  return [
    ...
    "10_module_1_ai_fundamentals/13_tools_and_agents.md",
    "10_module_1_ai_fundamentals/14_assessment_and_recap.md",
    ...
    "30_module_3_debugging/34_assessment_and_recap.md",
    // Module 4: Test Automation and Quality Assurance (User Stories 1, 2, 3 & 4)
      ...
      '40_module_4_testing/46_best_practices.md',
      '40_module_4_testing/47_assessment_and_recap.md',
